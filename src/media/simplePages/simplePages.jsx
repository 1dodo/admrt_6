...
<ul className='my-3'>
  <li class="flex "><BsDot className='mt-1' /> Describe your strengths and skills</li>
  <li class="flex "><BsDot className='mt-1' /> Highlight projects, accomplishments and education</li>
  <li class="flex "><BsDot className='mt-1' /> Keep it short and make sure it's error-free</li>
</ul>
      ...
      <div class="w-full order-2 md:w-2/3 ">
        ...
        <div class="bg relative w-full">
            ...
            <div className='flex justify-between'>
              <div className='flex button1 absolute top-[20%] left-[20%] md:left-[15%] gap-2'>
                ...
                <button className='text-xs md:text-sm font-semibold text-white'><h1>Edit Background</h1></button>
               </div>
        ...
        <div class="flex">
        <div class="rounded-full w-44 img border-4 border-white inline-block ml-6">
          <img class="w-24 h-24 md:w-full md:h-32 rounded-full" src={user} /><br />
        </div>
        ...
        <div className='w-full  py-2'>    
          <div className='flex justify-between '>
            <div class="flex justify-center items-center">
              ...
              <div class="flex">
              <h1 className='text-sm font-medium text-blue-800'><span className='text-sm text-gray-500'>Experitise: </span>Magician, Youtuber, Vlogs</h1>
           ...
           <div class="">
              <div className='flex gap-4 md:gap-8 items-center justify-center'>
                <div>
                <img class="h-4 w-4 md:w-7 md:h-8" src={svg1} />
                </div>
                <div>
                <img class="h-4 w-4 md:w-7 md:h-8" src={svg2} />
                </div>
                <div>
                <img class="h-4 w-4 md:w-7 md:h-8" src={svg3} />
                </div>
                <div>
                <img class="h-4 w-4 md:w-7 md:h-8" src={svg4} />
                </div>
